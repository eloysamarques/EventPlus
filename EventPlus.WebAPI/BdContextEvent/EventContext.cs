...
public partial class EventContext : DbContext
{
    ...
    public object Instituicoes { get; internal set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__4305A1F16573F08A");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC049FAAAF99");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D8B0F29E97");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5D3A32CEF5");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BED01A3794");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062BD59295B7");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9753891755");
